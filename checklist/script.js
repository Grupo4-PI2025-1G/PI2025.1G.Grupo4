document.addEventListener("DOMContentLoaded", function () {
    ...
    const descricoesSintomas = {
        ...
        "dor-abdominal": "Dor que ocorre entre o peito e a pelve. Pode ser leve ou muito intensa. <br> <br> <b> Causas: </b>  má digestão, gases, gastrite, cólica menstrual, apendicite, cálculos biliares. <br> <br> <b> Tipos: </b>  cólica, pontada, dor difusa. <br> <br> <b> Alívio: </b>  compressas mornas, evitar alimentos pesados, hidratação, repouso. Caso seja intensa e persistente, procurar atendimento.",
        "dor-de-estomago": "Um incômodo na região do estômago, geralmente relacionado à digestão. <br> <br> <b> Causas: </b>  gastrite, úlceras, refluxo, má alimentação, ansiedade. <br> <br> <b> Alívio: </b>  alimentação leve, evitar álcool, café e frituras, uso de chás calmantes (camomila, hortelã).",
        "febre": "Febre é a elevação da temperatura corporal acima de 37,8 °C. <br> <br> <b> Causas: </b>  infecções (virais, bacterianas), inflamações, insolação. <br> <br> <b> Tipos: </b>  baixa (até 38 °C), moderada (38–39 °C), alta (acima de 39 °C). <br> <br> <b> Alívio: </b>  hidratação, repouso, roupas leves, banho morno, uso de antitérmicos quando indicado.",
        "azia": "Os sintomas de azia podem acontecer após uma refeição com muito volume ou rica em gordura, já que a digestão é mais complicada e pode favorecer o retorno do conteúdo ácido do estômago para o esôfago, causando sensação de queimação no estômago, arroto constante, sensação de estômago cheio e gosto amargo na boca. A azia é uma situação bastante desconfortável e é mais comum de acontecer em mulheres grávidas e em pessoas que estão acima do peso, pois nestas situações o estômago sofre pressão das estruturas ao redor. Na presença de sintomas de azia, é importante que o gastroenterologista seja consultado para que seja identificada a causa e iniciado o tratamento mais adequado para aliviar e prevenir os sintomas. <br> <br> <b> Causas: </b>  alimentação gordurosa, bebidas alcoólicas, café, estresse. <br> <br> <b> Alívio: </b>  evitar deitar logo após comer, refeições leves, elevar a cabeceira da cama, evitar excessos alimentares.",
        "dor-na-costela": "Pode ser causada por esforço físico, trauma ou inflamação da cartilagem (costocondrite). <br> <br> <b> Causas: </b>  pancadas, tosse intensa, má postura. <br> <br> <b> Alívio: </b>  repouso, compressas mornas, analgésicos simples.",
        "dor-na-mama": "Também chamada de mastalgia, pode ser cíclica (ligada ao ciclo menstrual) ou não cíclica. <br> <br> <b> Causas: alterações hormonais, uso de anticoncepcionais, cistos mamários. <br> <br> <b> Alívio: uso de sutiã confortável, compressas mornas, evitar cafeína em excesso.",
        "dor-nas-articulacoes": "Conhecida como artralgia, pode afetar joelhos, cotovelos, punhos e outras articulações. <br> <br> <b> Causas: </b>  artrite, artrose, lesões, esforço repetitivo. <br> <br> <b> Tipos: </b> inflamatória, mecânica ou infecciosa. <br> <br> <b> Alívio: </b>  compressas mornas ou frias, exercícios leves de fortalecimento, fisioterapia.",
        "dor-no-ombro": "Muito comum por sobrecarga ou má postura. <br> <br> <b> Causas: </b>  tendinite, bursite, lesão muscular, pinçamento nervoso. <br> <br> <b> Alívio: </b>  alongamentos leves, compressas frias nos primeiros dias, fisioterapia.",
        ...
        "dor-nos-olhos": "Pode variar de ardência a dor profunda. <br> <br> <b> Causas: </b>  uso excessivo de telas, conjuntivite, glaucoma, inflamações. <br> <br> <b> Alívio: </b>  descanso visual, compressas frias, uso de colírio lubrificante.",
        "dor-nos-pes": "Comuns após longos períodos em pé. <br> <br> <b> Causas: </b>  calçados inadequados, fascite plantar, esporão ósseo. <br> <br> <b> Alívio: </b>  alongamentos, uso de calçados adequados, massagens.",
        "fraqueza-muscular": "Sensação de músculos sem força ou energia. <br> <br> <b> Causas: </b>  cansaço, má alimentação, anemias, distúrbios neuromusculares. <br> <br> <b> Alívio: </b>  boa nutrição, hidratação, exercícios regulares, tratar a causa de base.",
        "labirintite": "Distúrbio do labirinto (órgão do equilíbrio no ouvido interno). <br> <br> <b> Sintomas: </b>  tontura, desequilíbrio, náuseas. <br> <br> <b> Causas: </b>  infecções, alterações circulatórias, estresse. <br> <br> <b> Alívio: </b>  repouso, evitar movimentos bruscos, alimentação equilibrada, medicação sob prescrição.",
        "nauseas-vomitos": "Surgem por irritação no estômago ou estímulos cerebrais. <br> <br> <b> Causas: </b>  intoxicação alimentar, enxaqueca, labirintite, gravidez. <br> <br> <b> Alívio: </b>  hidratação em pequenas quantidades, repouso, evitar alimentos pesados.",
        "vertigem": "A vertigem é a sensação de que tudo ao redor está girando ou de que a própria pessoa está em movimento mesmo estando parada. Muitas vezes vem acompanhada de desequilíbrio, náuseas ou dificuldade para se manter em pé <br> <br> <b> Causas: </b>  alterações no ouvido interno (labirinto), como na vertigem posicional paroxística benigna, labirintite, pressão arterial baixa, estresse, enxaqueca ou problemas neurológicos. <br> <br> <b> Tipos: </b>  periférica (quando a origem está no labirinto, mais comum) e central (quando envolve o cérebro, mais rara, mas mais grave). <br> <br> <b> Alívio: </b>  repousar em posição confortável, evitar movimentos bruscos da cabeça, manter boa hidratação e procurar orientação médica para identificar a causa. Em alguns casos, manobras de reposicionamento ou medicação podem ser necessárias.",
        "zumbido-ouvido": "Sensação de apito ou chiado sem fonte externa. <br> <br> <b> Causas: </b>  exposição a sons altos, acúmulo de cera, alterações vasculares, estresse. <br> <br> <b> Alívio: </b>  evitar sons altos, tratar infecções ou causas associadas, técnicas de relaxamento.",
        "garganta-inflamada": "É a vermelhidão e irritação da mucosa da garganta. <br> <br> <b> Causas: </b>  infecções virais, bacterianas ou irritações ambientais (fumaça, poluição). <br> <br> <b> Alívio: </b>  hidratação, chás mornos, mel, gargarejos.",
    };
