document.addEventListener("DOMContentLoaded", function () {
    ...
    const descricoesSintomas = {
        ...
        'dor-no-ombro': 'Muito comum por sobrecarga ou má postura. <br> <br> <b> Causas: </b>  tendinite, bursite, lesão muscular, pinçamento nervoso. <br> <br> <b> Alívio: </b>  alongamentos leves, compressas frias nos primeiros dias, fisioterapia <a href="https://tuasaude.com"> <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        ...
        'dor-nos-olhos': 'Pode variar de ardência a dor profunda. <br> <br> <b> Causas: </b>  uso excessivo de telas, conjuntivite, glaucoma, inflamações. <br> <br> <b> Alívio: </b>  descanso visual, compressas frias, uso de colírio lubrificante <a href="https://www.minhavida.com.br"> <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'dor-nos-pes': 'Comuns após longos períodos em pé. <br> <br> <b> Causas: </b>  calçados inadequados, fascite plantar, esporão ósseo. <br> <br> <b> Alívio: </b>  alongamentos, uso de calçados adequados, massagens <a href="https://tuasaude.com"> <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'fraqueza-muscular': 'Sensação de músculos sem força ou energia. <br> <br> <b> Causas: </b>  cansaço, má alimentação, anemias, distúrbios neuromusculares. <br> <br> <b> Alívio: </b>  boa nutrição, hidratação, exercícios regulares, tratar a causa de base <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'labirintite': 'Distúrbio do labirinto (órgão do equilíbrio no ouvido interno). <br> <br> <b> Sintomas: </b>  tontura, desequilíbrio, náuseas. <br> <br> <b> Causas: </b>  infecções, alterações circulatórias, estresse. <br> <br> <b> Alívio: </b>  repouso, evitar movimentos bruscos, alimentação equilibrada, medicação sob prescrição <a href="https://tuasaude.com"> <i class="fa-solid fa-paperclip"></i>.',
        'nauseas-vomitos': 'Surgem por irritação no estômago ou estímulos cerebrais. <br> <br> <b> Causas: </b>  intoxicação alimentar, enxaqueca, labirintite, gravidez. <br> <br> <b> Alívio: </b>  hidratação em pequenas quantidades, repouso, evitar alimentos pesados <a href="https://tuasaude.com"> <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'vertigem': 'A vertigem é a sensação de que tudo ao redor está girando ou de que a própria pessoa está em movimento mesmo estando parada. Muitas vezes vem acompanhada de desequilíbrio, náuseas ou dificuldade para se manter em pé <br> <br> <b> Causas: </b>  alterações no ouvido interno (labirinto), como na vertigem posicional paroxística benigna, labirintite, pressão arterial baixa, estresse, enxaqueca ou problemas neurológicos. <br> <br> <b> Tipos: </b>  periférica (quando a origem está no labirinto, mais comum) e central (quando envolve o cérebro, mais rara, mas mais grave). <br> <br> <b> Alívio: </b>  repousar em posição confortável, evitar movimentos bruscos da cabeça, manter boa hidratação e procurar orientação médica para identificar a causa. Em alguns casos, manobras de reposicionamento ou medicação podem ser necessárias <a href="https://www.minhavida.com.br"> <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'zumbido-ouvido': 'Sensação de apito ou chiado sem fonte externa. <br> <br> <b> Causas: </b>  exposição a sons altos, acúmulo de cera, alterações vasculares, estresse. <br> <br> <b> Alívio: </b>  evitar sons altos, tratar infecções ou causas associadas, técnicas de relaxamento <a href="https://www.minhavida.com.br"> <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'garganta-inflamada': 'É a vermelhidão e irritação da mucosa da garganta. <br> <br> <b> Causas: </b>  infecções virais, bacterianas ou irritações ambientais (fumaça, poluição). <br> <br> <b> Alívio: </b>  hidratação, chás mornos, mel, gargarejos <a href="https://www.minhavida.com.br"> <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
    };
