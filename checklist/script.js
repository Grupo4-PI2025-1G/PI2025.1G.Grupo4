document.addEventListener("DOMContentLoaded", function () {
    ...
    const descricoesSintomas = {
        ...
        "garganta-inflamada": "É a vermelhidão e irritação da mucosa da garganta. <br> <br> Causas: </b>  infecções virais, bacterianas ou irritações ambientais (fumaça, poluição). <br> <br> Alívio: </b>  hidratação, chás mornos, mel, gargarejos.",
    };
