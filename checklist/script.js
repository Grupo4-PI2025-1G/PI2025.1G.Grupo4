document.addEventListener("DOMContentLoaded", function () {
    ...
    const descricoesSintomas = {
        ...
        "dor-de-cabeca": "A dor de cabeça é um sintoma comum que pode variar em intensidade, duração e localização (testa, têmporas, nuca). Se tem histórico familiar de enxaqueca, uma dor quase que contante e/ou de extremo nível, pode ser o motivo da dor. Mas sentir dor de cabeça todos os dias não é normal. Se ela estiver associada a sintomas como: febre alta, náuseas e vômito, desmaio e dificuldade para enxergar, busque imediatamente um médico especialista, que poderá realizar o diagnóstico adequado. <br> <br> <b>O que pode ajudar?</b> Beber água, descansar em um ambiente silencioso e escuro, aplicar compressa fria na testa ou massagem suave nas têmporas. Se for frequente, intensa ou acompanhada de sintomas como vômitos ou alterações na visão, deve-se procurar um médico.",
        "dor-de-cabeca": "A dor de cabeça é um sintoma comum que pode variar em intensidade, duração e localização (testa, têmporas, nuca). Se tem histórico familiar de enxaqueca, uma dor quase que contante e/ou de extremo nível, pode ser o motivo da dor. Mas sentir dor de cabeça todos os dias não é normal. Se ela estiver associada a sintomas como: febre alta, náuseas e vômito, desmaio e dificuldade para enxergar, busque imediatamente um médico especialista, que poderá realizar o diagnóstico adequado. <br> <br> <b>O que pode ajudar?</b> Beber água, descansar em um ambiente silencioso e escuro, aplicar compressa fria na testa ou massagem suave nas ttêmporas. Se for frequente, intensa ou acompanhada de sintomas como vômitos ou alterações na visão, deve-se procurar um médico.",
