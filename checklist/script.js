document.addEventListener("DOMContentLoaded", function () {
    ...
    const descricoesSintomas = {
        ...
        'dor-de-estomago': 'Um incômodo na região do estômago, geralmente relacionado à digestão. <br> <br> <b> Causas: </b>  gastrite, úlceras, refluxo, má alimentação, ansiedade. <br> <br> <b> Alívio: </b>  alimentação leve, evitar álcool, café e frituras, uso de chás calmantes (camomila, hortelã) <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        ...
        'dor-na-costela': 'Pode ser causada por esforço físico, trauma ou inflamação da cartilagem (costocondrite). <br> <br> <b> Causas: </b>  pancadas, tosse intensa, má postura. <br> <br> <b> Alívio: </b>  repouso, compressas mornas, analgésicos simples <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'dor-na-mama': 'Também chamada de mastalgia, pode ser cíclica (ligada ao ciclo menstrual) ou não cíclica. <br> <br> <b>Causas</b>: alterações hormonais, uso de anticoncepcionais, cistos mamários. <br> <br> <b>Alívio</b>: uso de sutiã confortável, compressas mornas, evitar cafeína em excesso <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        ...
        'dor-no-ombro': 'Muito comum por sobrecarga ou má postura. <br> <br> <b> Causas: </b>  tendinite, bursite, lesão muscular, pinçamento nervoso. <br> <br> <b> Alívio: </b>  alongamentos leves, compressas frias nos primeiros dias, fisioterapia <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        ...
        'dor-nos-olhos': 'Pode variar de ardência a dor profunda. <br> <br> <b> Causas: </b>  uso excessivo de telas, conjuntivite, glaucoma, inflamações. <br> <br> <b> Alívio: </b>  descanso visual, compressas frias, uso de colírio lubrificante <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'dor-nos-pes': 'Comuns após longos períodos em pé. <br> <br> <b> Causas: </b>  calçados inadequados, fascite plantar, esporão ósseo. <br> <br> <b> Alívio: </b>  alongamentos, uso de calçados adequados, massagens <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        ...
        'nauseas-vomitos': 'Surgem por irritação no estômago ou estímulos cerebrais. <br> <br> <b> Causas: </b>  intoxicação alimentar, enxaqueca, labirintite, gravidez. <br> <br> <b> Alívio: </b>  hidratação em pequenas quantidades, repouso, evitar alimentos pesados <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        ...
        'zumbido-ouvido': 'Sensação de apito ou chiado sem fonte externa. <br> <br> <b> Causas: </b>  exposição a sons altos, acúmulo de cera, alterações vasculares, estresse. <br> <br> <b> Alívio: </b>  evitar sons altos, tratar infecções ou causas associadas, técnicas de relaxamento <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
        'garganta-inflamada': 'É a vermelhidão e irritação da mucosa da garganta. <br> <br> <b> Causas: </b>  infecções virais, bacterianas ou irritações ambientais (fumaça, poluição). <br> <br> <b> Alívio: </b>  hidratação, chás mornos, mel, gargarejos <i class="fa-solid fa-paperclip"></i>. <br> <br> ',
    };
